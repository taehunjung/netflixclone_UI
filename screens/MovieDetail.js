...
const MovieDetail = ({navigation, route}) => {
        ...
        return (
            ...
            >
                <TouchableOpacity
                    ...
                    width: 50, height: 50, borderRadius: 20, backgroundColor: COLORS.transparentBlack
                    }}
    ...
    function renderHeaderSection() {
        return (
            <ImageBackground
                ...
                resizeMode="cover"
                style={{width: "100%", height: SIZES.height < 700 ? SIZES.height * 0.6 : SIZES.height * 0.7}}
            >
                <View style={{flex: 1}}>
                    {renderHeaderBar()}
    ...
    function renderCategoriesAndRatings() {
        return (
        ...
        return (
            <View style={{
                ...
                >
                    ...
                    >{selectedMovie?.details?.progress == "0%" ? "WATCH NOW" : "CONTINUE AGAIN"}</Text>
                </TouchableOpacity>
